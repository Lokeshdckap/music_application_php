...
<?php if(isset($_SESSION['Song Already Exists'])):?>
            ...
            <?php endif;?>
         <?php unset($_SESSION['Song Already Exists'])?>

<a class="btn btn-primary mt-3">Your Playlists</a>

<?php foreach($allPlaylists as $datas):?>
<ul>
<li>
<form action="/playlist/yourlist" method="POST">
<button class="btn btn-primary" name="playlist" value="<?php echo $datas['id']?>"><?php echo $datas['playlist_name']?></button>
</form>
</li>
</ul>
<?php endforeach;?>

<?php if(isset($_SESSION['playlistExists'])):?>
            <p class="bg-danger text-white"><?php echo $_SESSION['playlistExists']?></p>
<?php endif;?>
<?php unset($_SESSION['playlistExists'])?>

<form action="/playlist/createPlaylist" method="post">
<input type="text" placeholder="playlist" name="playlist"> 
<button class="btn btn-primary mt-3" name="user_id" value="<?php echo $_SESSION['id'];?>">Create a Playlist</a>
</form>
</section>